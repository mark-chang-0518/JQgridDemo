	...
	editGridRow : function(rowid, p){
		...
		return this.each(function(){
			...
			if ( $("#"+$.jgrid.jqID(IDs.themodal))[0] !== undefined ) {
				...
				// buttons at footer
                var bP = "<a href='javascript:void(0)' id='" + bp +"' class='fm-button ui-state-default ui-corner-left'>&nbsp<span class='ui-icon ui-icon-triangle-1-w'></span></a>",
                    bN = "<a href='javascript:void(0)' id='" + bn +"' class='fm-button ui-state-default ui-corner-right'>&nbsp<span class='ui-icon ui-icon-triangle-1-e'></span></a>",
	...
	viewGridRow : function(rowid, p){
		...
		return this.each(function(){
			...
			if ( $("#"+$.jgrid.jqID(IDs.themodal))[0] !== undefined ) {
				...
				// buttons at footer
				bP = "<a href='javascript:void(0)' id='"+bp+"' class='fm-button ui-state-default ui-corner-left'>&nbsp<span class='ui-icon ui-icon-triangle-1-w'></span></a>",
                    bN = "<a href='javascript:void(0)' id='" + bn +"' class='fm-button ui-state-default ui-corner-right'>&nbsp<span class='ui-icon ui-icon-triangle-1-e'></span></a>",
